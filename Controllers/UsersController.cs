...
namespace WebApplication1.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,Email,LastName,FirstName")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Email,LastName,FirstName")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
